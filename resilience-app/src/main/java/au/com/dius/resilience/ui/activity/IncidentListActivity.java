...
public class IncidentListActivity extends RoboListActivity implements RepositoryCommandResultListener<Incident> {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    super.setListAdapter(new ListViewAdapter(this, R.layout.incident_list_view_item, Collections.EMPTY_LIST));
  ...
  public void commandComplete(final RepositoryCommandResult<Incident> result) {
    this.setListAdapter(
            new ListViewAdapter(this, R.layout.incident_list_view_item, result.getResults()));
  }
